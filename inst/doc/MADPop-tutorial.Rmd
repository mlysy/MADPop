...
author: "Wookjung P. Kim, Terin Robinson, Martin Lysy"
date: "`r Sys.Date()`"
...
This data is converted into a numeric format to be used with **MADPop** with the command `UM.suff`.

`UM.suff` is a function that converts a matrix of raw allele data into the quantities needed to describe the corresponding Hardy-Weinberg model.
...
Sample from the posterior distribution. This has 11 lakes, with Simcoe and Michipicoten having been grouped together.
